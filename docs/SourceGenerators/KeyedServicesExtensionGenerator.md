...
public class MyServiceTests
{
    ...
    public void Test_WithKeyedService()
    {
        ...
        IEmailSender primarySender = Substitute.For<IEmailSender>();
...
public void Test_MultipleKeyedServices()
{
    ...
    IEmailSender primary = Substitute.For<IEmailSender>();
    IEmailSender backup = Substitute.For<IEmailSender>();
...
public void Test_KeyedServiceWithDependencies()
{
    ...
    // The CacheService will be created with its logger dependency automatically substituted
...
{
    AutoMocker mocker = new();
    mocker.WithKeyedService(Substitute.For<IService>(), ServiceKeys.Primary);
