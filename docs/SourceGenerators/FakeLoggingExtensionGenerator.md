...
When your test project references `Microsoft.Extensions.Diagnostics.Testing`, this generator creates a `WithFakeLogging()` extension method that sets up fake logging for testing.
...
```xml
<PropertyGroup>
  <EnableAutoMockerNSubstituteFakeLoggingGenerator>false</EnableAutoMockerNSubstituteFakeLoggingGenerator>
</PropertyGroup>
```
...
- [Fake Time Provider Extension Generator](FakeTimeProviderExtensionGenerator.md)
