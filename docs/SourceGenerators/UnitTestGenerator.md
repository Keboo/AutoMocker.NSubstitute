...
### AMG0002: Must reference AutoMocker.NSubstitute

**Warning:** Your test project must reference the AutoMocker.NSubstitute NuGet package to use the source generators.
...
1. Ensure your project references `AutoMocker.NSubstitute`
