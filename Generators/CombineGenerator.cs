    ...
    private static CompilationUnitSyntax GetCompilationUnit()
    {
        ...
        return CompilationUnit()
            .WithMembers(SingletonList<MemberDeclarationSyntax>(
                FileScopedNamespaceDeclaration(QualifiedName(IdentifierName("NSubstitute"), IdentifierName("AutoMock")))
                    .WithMembers(SingletonList<MemberDeclarationSyntax>(
        ...
        return DocumentationComment(
            ...
            XmlSummaryElement(
                new[]
                {
                    ...
                    @"substitute. Some IoC containers call this ""Forwarding"" one type to",
