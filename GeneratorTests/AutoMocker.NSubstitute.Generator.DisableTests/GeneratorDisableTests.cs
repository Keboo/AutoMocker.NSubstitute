...
public class GeneratorDisableTests
{
    ...
    {
        // When EnableAutoMockerNSubstituteHttpClientFactoryGenerator=false, the HTTP client factory
        // extension methods should not be generated
        ...
        Assert.False(hasGeneratedHttpClientFactoryExtension,
            "WithHttpClientFactory extension method should not exist when EnableAutoMockerNSubstituteHttpClientFactoryGenerator=false");
    }
