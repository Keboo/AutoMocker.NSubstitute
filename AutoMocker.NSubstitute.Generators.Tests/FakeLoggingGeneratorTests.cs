...
using VerifyCS = AutoMocker.NSubstitute.Generators.Tests.CSharpSourceGeneratorVerifier<AutoMocker.NSubstitute.Generators.FakeLoggingExtensionSourceGenerator>;
...
public class FakeLoggingGeneratorTests
{
    private const string ExpectedFakeLoggingGeneratedFile = """
        #nullable enable
        // Generated by AutoMocker.NSubstitute.Generators.FakeLoggingExtensionSourceGenerator.
        ...
        namespace NSubstitute.AutoMock
        {
            ...
            static partial class AutoMockerFakeLoggingExtensions
            {
                ...
                private sealed class FakeLoggerResolver : ISubstituteResolver
                {
    ...
    public async Task WhenGeneratorIsDisabled_NoGenerationOccurs()
    {
        ...
        test.SetGlobalOption("build_property.EnableAutoMockerNSubstituteFakeLoggingGenerator", "false");
    ...
    public async Task WhenGeneratorIsExplicitlyEnabled_ExtensionMethodIsGenerated()
    {
        ...
        test.SetGlobalOption("build_property.EnableAutoMockerNSubstituteFakeLoggingGenerator", "true");
        await test.RunAsync(TestContext.CancellationToken);
    }

    private static (string FileName, SourceText SourceText) GetSourceFile(string content, string fileName)
    {
        return (Path.Combine("AutoMocker.NSubstitute.Generators", "AutoMocker.NSubstitute.Generators.FakeLoggingExtensionSourceGenerator", fileName), SourceText.From(content, Encoding.UTF8, SourceHashAlgorithm.Sha256));
    }
