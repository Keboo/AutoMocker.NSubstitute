...
using VerifyCS = AutoMocker.NSubstitute.Generators.Tests.CSharpSourceGeneratorVerifier<AutoMocker.NSubstitute.Generators.KeyedServicesExtensionSourceGenerator>;
...
public class KeyedServicesGeneratorTests
{
    private const string ExpectedKeyedServicesGeneratedFile = """
        #nullable enable
        // Generated by AutoMocker.NSubstitute.Generators.KeyedServicesExtensionSourceGenerator.
        ...
        namespace NSubstitute.AutoMock
        {
            ...
            static partial class AutoMockerKeyedServicesExtensions
            {
                ...
                private class ServiceProviderResolver : ISubstituteResolver
                {
    ...
    public async Task WhenGeneratorIsDisabled_NoGenerationOccurs()
    {
        ...
        test.SetGlobalOption("build_property.EnableAutoMockerNSubstituteKeyedServicesGenerator", "false");
    ...
    public async Task WhenGeneratorIsExplicitlyEnabled_ExtensionMethodIsGenerated()
    {
        ...
        test.SetGlobalOption("build_property.EnableAutoMockerNSubstituteKeyedServicesGenerator", "true");
        await test.RunAsync(TestContext.CancellationToken);
    }

    private static (string FileName, SourceText SourceText) GetSourceFile(string content, string fileName)
    {
        return (Path.Combine("AutoMocker.NSubstitute.Generators", "AutoMocker.NSubstitute.Generators.KeyedServicesExtensionSourceGenerator", fileName), SourceText.From(content, Encoding.UTF8, SourceHashAlgorithm.Sha256));
    }
