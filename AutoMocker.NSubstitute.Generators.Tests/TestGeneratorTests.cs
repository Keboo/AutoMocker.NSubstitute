        ...
        string expected = """
            namespace TestNamespace
            {
                partial class ControllerTests
                {
                    ...
                    partial void ControllerConstructor_WithNullstring_ThrowsArgumentNullExceptionSetup(NSubstitute.AutoMock.AutoMocker mocker);
        ...
        string expectedFirstNamespace = """
            namespace FirstNamespace
            {
                partial class ControllerTests
                {
                    ...
                    partial void ControllerConstructor_WithNullIService_ThrowsArgumentNullExceptionSetup(NSubstitute.AutoMock.AutoMocker mocker);
        ...
        string expectedSecondNamespace = """
            namespace SecondNamespace
            {
                partial class ControllerTests
                {
                    ...
                    partial void ControllerConstructor_WithNullILogger_ThrowsArgumentNullExceptionSetup(NSubstitute.AutoMock.AutoMocker mocker);
