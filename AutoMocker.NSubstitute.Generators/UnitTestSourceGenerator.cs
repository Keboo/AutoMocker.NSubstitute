...
public sealed class UnitTestSourceGenerator : IIncrementalGenerator
{
    ...
    {
        // Check if NSubstitute.AutoMock is referenced
        ...
        IncrementalValuesProvider<(GeneratorTargetClass? targetClass, ImmutableArray<Diagnostic> diagnostics)> commandInfoWithErrors =
            ...
            .ForAttributeWithMetadataName(
                "NSubstitute.AutoMock.ConstructorTestsAttribute",
    ...
    private static string GenerateTestClass(GeneratorTargetClass testClass, TargetTestingFramework testingFramework)
    {
        ...
        builder.AppendLine("    {");
        builder.AppendLine("        partial void AutoMockerTestSetup(NSubstitute.AutoMock.AutoMocker mocker, string testName);");
        ...
        foreach (NullConstructorParameterTest test in testClass.Sut?.NullConstructorParameterTests ?? Enumerable.Empty<NullConstructorParameterTest>())
        {
            ...
            builder.AppendLine();
            builder.AppendLine($"        partial void {testName}Setup(NSubstitute.AutoMock.AutoMocker mocker);");
            builder.AppendLine();
            ...
            builder.AppendLine("        {");
            builder.AppendLine("            NSubstitute.AutoMock.AutoMocker mocker = new NSubstitute.AutoMock.AutoMocker();");
    ...
    private static bool GetSkipNullableParameters(AttributeData constructorTestsAttribute)
    {
        ...
        {
            if (arg.Type?.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat) == "global::NSubstitute.AutoMock.TestGenerationBehavior")
            {
