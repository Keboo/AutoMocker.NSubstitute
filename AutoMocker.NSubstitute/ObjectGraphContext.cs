...
public class ObjectGraphContext
{
    ...
    /// </summary>
    /// <param name="enablePrivate">Enable private members</param>
    /// <param name="isSubstituteCreation">Indicates if the object is for a substitute instance.</param>
    public ObjectGraphContext(bool enablePrivate, bool isSubstituteCreation)
        : this(enablePrivate)
    {
        IsSubstituteCreation = isSubstituteCreation;
    }
    ...
    /// <summary>
    /// Flags used when searching for constructors.
    /// </summary>
