...
/// </summary>
public class SubstituteResolutionContext
{
    private object? _value;

    /// <summary>
    /// Initializes an instance of SubstituteResolutionContext.
    /// </summary>
    ...
    /// Context within the object graph being created. This differs from the SubstituteResolutionContext which is
    /// only relevant for a single object creation.
    /// </param>
    public SubstituteResolutionContext(AutoMocker autoMocker, Type requestType, ObjectGraphContext objectGraphContext)
    {
